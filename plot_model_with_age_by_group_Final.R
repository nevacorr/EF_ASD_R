...
plot_model_with_age_by_group_Final <- function(result, score_column, use_covariates) {
  ...
  # Save plot to file
  ggsave(paste0("Standardized Raw Scores by Group and Age_", score_column, covstr, ".png"), 
  ...
  # Save plot to file
  ggsave(paste0("Model of Individual Scores by Age_", score_column, covstr, ".png"), 
         plot = plot, width = 9, height = 7,dpi = 300, bg="white")
  ...
  # Save plot to file
  ggsave(paste0("Model of Standardized Scores by Group and Age_", 
               score_column, "_Used for School Age Score", covstr, ".png"), 
               plot = plot, width = 9, height = 7, dpi = 300, bg="white")
